...
public class Post {
	...
	public Post(String id, String userId, String topicId, String title, String content, Date createdAt, Date updatedAt,
			String accessLevelId, String allowComment, List<String> allowViewer, Date month, Date year) {
		super();
		this.id = id;
		this.userId = userId;
	...
	public Post(String userId, String topicId, String title, String content, String accessLevelId, String allowComment,
			Date month, Date year, List<String> allowViewer) {
		this.userId = userId;
		this.topicId = topicId;
		this.title = title;
		this.content = content;
