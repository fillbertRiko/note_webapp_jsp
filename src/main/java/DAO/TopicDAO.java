...
public class TopicDAO {
	...
	private Topic documentToTopic(Document doc) {
		...
		Topic topic = new Topic(doc.getObjectId("_id").toHexString(), doc.getString("userId"), doc.getString("name"),
				doc.getString("description"), doc.getDate("createdAt"));
		return topic;
	}
	...
	public boolean updateTopic(Topic topic) {
		...
		try {
			...
			Document updateFields = new Document("$set",
					new Document().append("userId", topic.getUserId()).append("name", topic.getName())
							.append("description", topic.getDescription()).append("createdAt", topic.getCreatedAt()));
	...
	public void createTopic(Topic topic) {
		Document topicDoc = new Document("_id", new ObjectId()).append("userId", topic.getUserId())
				.append("name", topic.getName()).append("description", topic.getDescription())
